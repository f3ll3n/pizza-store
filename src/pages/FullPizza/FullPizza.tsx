  ...
  return (
    <div className={styles.root}>
      <div className={styles.back}>
        <Link to="/" className={styles.closePizza}>
          {"< "}Вернуться назад{" "}
        </Link>
      </div>
        ...
        <div className={styles.pizzaMain}>
          ...
          <div className={styles.pizzaRight}>
            ...
            <div className={styles.price}>
              <p className="pizza-block__price">
                Цена:{" "}
                {Math.round(data.price + (data.price * activeSizeIndex) / 2)} ₽
              </p>
              <button
                ...
                onClick={() => {
                  dispatch(
                    addItem({
                      ...
                      img: data.imageUrl,
                      price: Math.round(
                        data.price + (data.price * activeSizeIndex) / 2,
                      ),
